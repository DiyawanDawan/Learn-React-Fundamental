...
const EditJobPage = ({updateJobSubmit}) => {
    ...
    const [contactEmail, setCompanycontactEmail] = useState(job.company.contactEmail);
    const [contactPhone, setCompanyContactPhone] = useState(job.company.contactPhone);
    const {id} = useParams()
